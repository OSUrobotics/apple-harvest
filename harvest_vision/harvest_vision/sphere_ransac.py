...
## Borrowed from Pyransac, adds in radius constraint. (Constraint could be improved/optimized)
...
class Sphere():
    ...
    def fit(self, pts, thresh=0.2, maxIteration=1000, lower_rad_bound=.03, upper_rad_bound=.06):
        """
        ...
        for it in range(maxIteration):
            ...
            radius = max(radius, lower_rad_bound)
