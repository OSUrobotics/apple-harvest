...
class CoordinateToTrajectoryService(Node):
    def __init__(self):
        ...
        self.voxel_data = np.loadtxt(os.path.join(package_share_directory, 'resource', 'finray/reachable_voxels_20251014_170854.csv')) #'alejo_v2/reachable_voxels_20251029_221624.csv'   'finray/Hot_fix_1/reachable_voxels_20251028_222036.csv'
        self.trajectories = np.load(os.path.join(package_share_directory, 'resource', 'reachable_paths.npy')) #'alejo_v2/reachable_paths_20251029_221623.npy'    'finray/Hot_fix_1/reachable_paths_20251028_222035.npy'
        self.ik_data = np.loadtxt(os.path.join(package_share_directory, 'resource', 'finray/voxel_ik_data_20251014_170852.csv'), delimiter=',', skiprows=1) #'alejo_v2/voxel_ik_data_20251029_221622.csv'    'finray/Hot_fix_1/voxel_ik_data_20251028_222034.csv'
